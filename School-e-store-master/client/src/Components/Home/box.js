...
function Box(params) {
    return (<Row style={{width:"100%",paddingLeft:"25px"}} className="m-0">
    ...
    <Card.Body>
      ...
      <img style={{marginTop:"-100px",width:"150px",height:"200px",marginLeft:"140px"}} src={Nursery} />
    </Card.Body>
  </Card>
  </Col>
  <Col style={{display:"flex",justifyContent:"space-around"}}lg={4} md={6} sm={6} xs={12}>
  <Card className="cardDesign" style={{marginTop:"20px",background: "linear-gradient(219.56deg, rgba(0, 0, 0, 0.2) -14.19%, rgba(1, 1, 1, 0.2) 23.05%, rgba(255, 255, 255, 0.136875) 67.91%, rgba(0, 0, 0, 0) 103.79%),linear-gradient(0deg, rgba(20, 0, 255, 0.2), rgba(20, 0, 255, 0.2))"}}>
    <Card.Body>
      ...
      <Card.Img style={{marginTop:"-120px",width:"150px",height:"200px"}} src={Book2} />
    </Card.Body>
  </Card>
  </Col>
  <Col style={{display:"flex",justifyContent:"space-around"}} lg={4} md={6} sm={6} xs={12}>
  ...
  <Card className="cardDesign" style={{marginTop:"20px",background: "#FFD60099"}}>
    <Card.Body>
      ...
      <Card.Img style={{marginTop:"-50px",width:"200px",height:"300px",marginLeft:"100px"}} src={Pen} />
    </Card.Body>
  </Card>
  </Col>
